...
<div class="flex space-x-4 mt-4">
    <div class="w-1/4 bg-green-100 p-4 rounded-md">
        ...
        <table class="table">
            <tr><th class="bg-green-900 text-white">Room Name</th></tr>
            <tr><td class="bg-white text-green-900 text-center font-bold text-xl">{{$room->name}}</td></tr>
            <tr><th class="bg-green-900 text-white">Description</th></tr>
            <tr><td class="bg-white text-green-900 text-center">{{$room->description}}</td></tr>
            <tr><th class="bg-green-900 text-white">Room Type</th></tr>
            <tr><td class="bg-white text-green-900 text-center">{{$room->room_type}}</td></tr>
            <tr><th class="bg-green-900 text-white">Rate</th></tr>
            <tr>
        ...
        <button class="secondary mt-4 w-full" id="editCurrentRoomButton">
            <i class="fa fa-edit"></i> Edit Room Details
        </button>
    </div>
...
$(document).ready(()=>{
    ...
    $("#editCurrentRoomButton").click(()=>{
        $(".modal-backdrop, .modal-wrapper").removeClass('hidden')
    })
